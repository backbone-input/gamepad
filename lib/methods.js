	...
	var methods = {
		...
		monitorGamepad: function( state ){
			...
			if( state && getGamepads){
				window.addEventListener('gamepadconnected', _.bind(this._onConnectGamepad, this), false );
				window.addEventListener('gamepaddisconnected', _.bind(this._onDisconnectGamepad, this), false );
				// watch for new connections
				scanInterval = setInterval( _.bind(this._scanGamepads, this), 500);
				// broadcast event
				this.trigger('monitor-gamepad-on');
			} else {
				window.removeEventListener('gamepadconnected', _.bind(this._onConnectGamepad, this), false );
				window.removeEventListener('gamepaddisconnected', _.bind(this._onDisconnectGamepad, this), false );
		...
		_onConnectGamepad: function( e ) {
			...
			// app-specific logic
			return this.onConnectGamepad( e );
		},
		...
		_onDisconnectGamepad: function( e ) {
			...
			// app-specific logic
			return this.onDisconnectGamepad( e );
		},
